...
# 二分
1.while 的条件大多数需要是 l <= r，但也有例外，比如区间是左开右闭等情况，需要注意 l 和 r 的条件，如 l + 1 < r     
2.可以根据记录比 mid 大、小的数，根据数量来判断大部分数比 mid 大还是小，再进行下一步处理，而上述特殊情况，就不同了，可能会有直接令 l、r 等于 mid 的情况，比如需要保持一个确定可行的临界值，再去讨论剩下未知的情况    
